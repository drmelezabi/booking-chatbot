...
const backupMessageTemplate = (level: levels, information: string): string => {
  try {
    const now = new Date();
    ...
    const debugTemplate = `
      ...
      <body>
          <div class="email-header">${
            level === "info" ? "Local DB Backup Files" : "Warning"
          }</div>
          <div class="email-body">
              <p>Hello,</p>
              <p>This is a backup for ${dateString}:</p>
              <p>${information}</p>
...
export default backupMessageTemplate;
